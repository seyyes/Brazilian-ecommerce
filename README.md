...
Welcome to E-commerce Logistics Performance Analysis (Olist Dataset)
## 1. Project Overview
## Objective
...
- Dimensions:
  ...
  - Additional Dimensions (Used for time-series analysis and delay segmentation): 
    - dim_date
    - dim_delay_bucket
![Data model](../Brazilian_ecommerce/assets/data_model.png)
...
- ![Logistics overview](../Brazilian_ecommerce/assets/logistics_overview.png)
...
- Pareto analysis
- ![Seller performance](../Brazilian_ecommerce/assets/seller_performance.png)

### 7.3 Customer Satisfaction
- impact of delays on reviews
- satisfaction vs delivery time
- ![Customer satisfaction](../Brazilian_ecommerce/assets/customer_satisfaction.png)
